...
ORDER BY `ord`'
	...
	while ($route = $rs->fetchRow()) {
		...
		echo '<td>';
		if ($i > 0)
			echo '<a href="', gs_url($SECTION, $MODULE), '&amp;ggid=', $ggid ,'&amp;action=move-up&amp;id=', $route['id'], '"><img alt="&uarr;" src="', GS_URL_PATH, 'img/move_up.gif" /></a>';
		else
			echo '<img alt="&uarr;" src="', GS_URL_PATH, 'img/move_up_d.gif" />';
		if ($i < $rs->numRows()-1)
			echo '&thinsp;<a href="', gs_url($SECTION, $MODULE), '&amp;ggid=', $ggid ,'&amp;action=move-down&amp;id=', $route['id'], '"><img alt="&darr;" src="', GS_URL_PATH, 'img/move_down.gif" /></a>';
		else
			echo '&thinsp;<img alt="&darr;" src="', GS_URL_PATH, 'img/move_down_d.gif" />';
		echo ' &nbsp; <a href="', gs_url($SECTION, $MODULE), '&amp;ggid=', $ggid ,'&amp;action=del&amp;id=', $route['id'], '"><img alt="-;" src="', GS_URL_PATH, 'img/minus.gif" /></a>';
		echo '</td>', "\n";
	...
	echo '<td class="transp">';
	echo '<nobr><input type="text" value="00" size="2" maxlength="2" disabled="disabled" />';
	echo ':<input type="text" value="00" size="2" maxlength="2" disabled="disabled" /></nobr>';
	echo ' - <nobr><input type="text" value="24" size="2" maxlength="2" disabled="disabled" />';
	echo ':<input type="text" value="00" size="2" maxlength="2" disabled="disabled" /></nobr>';
	echo '</td>', "\n";
