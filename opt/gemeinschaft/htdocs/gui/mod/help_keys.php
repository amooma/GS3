...
<tr>
	...
	<td style="width:420px;">
		<?php echo __('Beschreibt die Taste am Telefon, im Beispiel ist F001 die oberste Taste am Display vom Siemens Openstage 60.'); ?>
	</td>
</tr>
<tr>
	<td>:=</td>
...
<tr>
	...
	<td>
		<?php echo __('Schaltet den Rufton des Endger&auml;tes an oder aus. Wenn der Rufton aus ist, leuchtet die Lampe der Taste.'); ?>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<?php echo __('Sie k&ouml;nnen diese Funktion aktivieren, falls Sie z.B. im Kundengespr&auml;ch sind und nicht gest&ouml;rt werden wollen. Das Telefon wird dann nicht klingeln und auch nicht anzeigen, wenn es angerufen wird.'); ?>
	</td>
</tr>
<tr>
