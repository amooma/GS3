...
echo '<p class="text"><small><sup>[1]</sup> ', __('PtP (Point-to-Point) bei einem Anlagenanschlu&szlig;, PtMP (Point-to-MultiPoint) bei einem Mehrger&auml;teanschlu&szlig; (Basis-ISDN).') ,'</small></p>' ,"\n";
